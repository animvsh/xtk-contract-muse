...
const POOL: (Omit<Update, "id" | "ts"> & { detail: Detail })[] = [
  ...
  { icon: Mail, source: "Gmail", text: "Contract signed by adithya@beevr.io", color: "oklch(0.6 0.22 25)", detail: { actor: "Adithya Rao", action: "signed contract", target: "MSA · Globex Corp", preview: "Counter-signed via DocuSign. Effective Nov 15. Auto-renews annually unless cancelled 30 days prior.", meta: [{ label: "Vendor", value: "Globex Corp" }, { label: "Effective", value: "Nov 15, 2026" }] } },
];
