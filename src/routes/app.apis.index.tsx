...
import { Server, Plus, Trash2, PlayCircle, Loader2 } from "lucide-react";
        ...
        {loading ? (
          ...
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            {rows.map((api) => (
              <div
                key={api.id}
                className="clicky-sm group relative cursor-pointer rounded-2xl border border-black/5 bg-white p-4 transition hover:border-primary/30 hover:shadow-lg"
