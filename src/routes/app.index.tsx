...
function AppHome() {
  ...
  return (
    <div className="mx-auto flex w-full max-w-3xl flex-col px-6 pt-24">
      ...
      <form
        ...
        className="mt-8"
      >
        <div className="flex items-center gap-2 rounded-2xl border border-black/[0.08] bg-white/80 p-2 shadow-sm backdrop-blur transition-colors focus-within:border-primary/50 focus-within:shadow-md">
