  ...
  head: () => ({
    meta: [
      { title: "Cloud builds — Beevr Docs" },
      {
        name: "description",
        content:
          "Build agents, tools, dashboards, and APIs in the Beevr cloud — no infra to manage.",
      },
    ],
  }),
    ...
    <DocsShell>
      ...
      <DocsSection title="The default flow">
        <ol className="list-decimal space-y-2 pl-5 text-sm">
          ...
          <li>
            Click <span className="font-semibold">Build in Cloud</span>.
          </li>
      ...
      <DocsSection title="What you can build">
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
          <DocsCard
            to="/docs/cloud-builds/agents"
            title="Agents"
            description="Recurring workflows like daily summaries or watchdogs."
          />
          <DocsCard
            to="/docs/building-tools"
            title="Tools"
            description="Reusable capabilities surfaced in chat and team spaces."
          />
          <DocsCard
            to="/docs/examples"
            title="Dashboards & APIs"
            description="Internal dashboards and endpoints powered by workspace data."
          />
          <DocsCard
            to="/docs/approvals"
            title="Safety & approvals"
            description="How risky actions are gated before going live."
          />
        </div>
      </DocsSection>
